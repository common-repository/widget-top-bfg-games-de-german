<?php
/*  Copyright 2008-2011 Denis "Mr.Snow" Kozhukhov  (email : mrsnow@chocosnow.com), ChocoSnow.com
...
/*
Plugin Name: Widget Top BFG Games DE
Plugin URI: http://www.chocosnow.de/blog/widget-bfg-top-games/
Description: Diese einfache Plugin ist ein Widget, das eine deutsche Liste der Top-Casual-Games-Displays von BigFish DE (German, .de) auf Ihrem widgetized Seitenleiste. ENGLISH: This simple plugin is a widget that displays a DE (German, .de) list of top casual games from BigFish on your widgetized sidebar.
Author: <a href="http://www.chocosnow.com/">ChocoSnow.com</a>, <a href="http://www.chocosnow.de/">ChocoSnow.de</a>, <a href="http://www.mrsnow.info/">Denis "Mr.Snow" Kozhukhov</a>
...
function widget_mrsnow_bfgtopgames_DE_work ($before, $after)
{
	$options = (array) get_option ('widget_mrsnow_bfgtopgames_DE');
	if ($options['channel']==null) 
	{
		$options['channel'] = str_replace ('.', '', str_replace ('_', '', str_replace ('-', '', $_SERVER['HTTP_HOST'])));
		update_option ('widget_mrsnow_bfgtopgames_DE', $options);
	};
	...
	$md5 = hash ("md5", $url);
	$options2 = $newoptions2 = get_option ('widget_mrsnow_bfgtopgames_DE_'.$md5);
	...
	if ($options2['csurl'] == '') 
	{
		...
		else if ($variant == 1)
		{
			...
			if ($lang=='jp') 
				...
				$newoptions2['csurl'] = $csurl[$lang].GenerateIdFromTitle_DE ($variantTitle).'/';
		...
		if ($options2 != $newoptions2) 
		{
			...
			update_option ('widget_mrsnow_bfgtopgames_DE_'.$md5, $options2);
		};
	};	
...
function GenerateIdFromTitle_DE ($title)
{
...
function widget_mrsnow_bfgtopgames_DE_control () 
{
	$text['title'] = 'Widget Titel:';
	$text['titled'] = 'Beste BigFish Spiele';
	$text['gnum'] = 'Anzahl der Spiele, um Display:';
	$text['gtype'] = 'Spiele Typs angezeigt:';
	$text['gtypep'] = 'PC-Spiele';
	//$text['gtypem'] = 'Mac Games (English sites only)';
	$text['gtypeo'] = 'Online-Spiele';
	//$text['glang'] = 'Games Language to Display:';
	$text['align'] = 'Text und Bilder ausrichten:';
	$text['alignd'] = 'Thema default';
	$text['alignr'] = 'Recht';
	$text['alignl'] = 'Link';
	$text['alignc'] = 'Zentrum';
	$text['bullets'] = 'Zeige Aufzählungszeichen';
	$text['pos'] = 'Zeige Spiele Position';
	$text['img'] = 'Zeige Spiele Bilder';
	$text['imgtype'] = 'Bilder Typ:';
	$text['imgtypes'] = 'Klein (60x40)';
	$text['imgtyped'] = 'Default (80x80)';
	$text['imgtypef'] = 'Feature (175x50)';
	$text['imgtypesf'] = 'Subfeature (175x50)';
	$text['showt'] = 'Zeige Spiele Text';
	$text['titlepos'] = 'Titel Position:';
	$text['titleposti'] = 'Titel obere Bild';
	$text['titleposit'] = 'Bild oben Titel';
	$text['bfglogin'] = 'Ihre <a href="http://affiliates.bigfishgames.com/index.html?afcode=af6e89e0ae1a">BigFishGames Affiliate</a> anmelden:';
	$text['bfgloginnb'] = 'Sie können dieses Feld leer lassen, <br/> Widget kann ohne Anmeldung funktioniert, <br/> oder benutzen Sie richtig anmelden.';
	$text['bfgchan'] = 'BigFishGames Affiliate-Client-Kanal:';
	$text['bfgchannb'] = 'Domain-Namen wird standardmäßig verwendet werden. <br/> Lassen Sie dieses Feld leer ist, nicht zu verwenden Kanäle. <br/> Bitte verwenden Sie alphanumerische nur.';
	$text['copy'] = 'Copyright 2008-2011 durch <a href="http://www.chocosnow.de/">ChocoSnow.de</a>';

	$options = $newoptions = get_option ('widget_mrsnow_bfgtopgames_DE');
	...
	$options['lang'] = $options['lang'] ? $options['lang'] : 'de';
...
function widget_mrsnow_bfgtopgames_DE_init () 
{	
	...
	function widget_mrsnow_bfgtopgames_DE ($args) 
	{
		extract ($args);
		//$start = mrsnow_microtime_float ();
		//echo $before_widget;
		echo "\n".'<!-- Widget Top BFG Games DE: START -->'."\n";
		echo widget_mrsnow_bfgtopgames_DE_work ($before_title, $after_title);
		echo "\n".'<!-- Widget Top BFG Games DE: END -->'."\n";
		//echo $after_widget;
	...
	register_sidebar_widget (array ('Widget Top BFG Games DE', 'widgets'), 'widget_mrsnow_bfgtopgames_DE');
	register_widget_control (array ('Widget Top BFG Games DE', 'widgets'), 'widget_mrsnow_bfgtopgames_DE_control');
};

// Delay plugin execution to ensure Dynamic Sidebar has a chance to load first
add_action ('widgets_init', 'widget_mrsnow_bfgtopgames_DE_init');
